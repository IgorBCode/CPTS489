    ...
    return (
        <div className="content-container flex-fill">
            ...
            <div className="container mt-4">
                ...
                {/* Posts */}
                <div className="row">
                    <div className="col-12 mb-3 my-2">
                                    ...
                                    <div className="d-flex align-items-center">
                                        <h5 className="mb-0">
                                            <a href="post.html" className="text-decoration-none">
                                                Maecenas eget odio sit amet nisl laoreet aliquam eu a
                                                ipsum.{" "}
                                            </a>
                                        </h5>
                                    </div>
                                    <div className="mt-1">
                                        <small className="text-muted">Posted by billybob</small>
                                        <br />
                                        <a href="post.html" className="text-decoration-none">
                                            <span className="text-muted">💬 34 Comments</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="card p-3">
                            <div className="d-flex">
                                ...
                                <div>
                                    ...
                                    <div className="mt-1">
                                        <small className="text-muted">Posted by charlie</small>
                                        <br />
                                        <a href="post.html" className="text-decoration-none">
                                            <span className="text-muted">💬 1645 Comments</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
